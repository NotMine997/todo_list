...
<template>
  <main
    class="min-h-screen bg-bg-primary py-12 px-4 sm:px-6 lg:px-8 font-sans text-text-primary transition-colors duration-200"
  >
    <div
      class="w-1/2 mx-auto bg-surface-primary rounded-xl shadow-md overflow-hidden p-6 transition-colors duration-200"
    >
      <div class="flex items-center justify-between mb-6">
        ...
        <span
          class="bg-accent text-text-on-accent text-s font-semibold px-2.5 py-1 rounded-full transition-colors duration-200"
        >
